...
describe FeedbacksController do
  ...
  let(:valid_attributes) { { "feedback" => "MyText" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved feedback as @feedback" do
        ...
        post :create, {:feedback => { "feedback" => "invalid value" }}, valid_session
        assigns(:feedback).should be_a_new(Feedback)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested feedback" do
        ...
        Feedback.any_instance.should_receive(:update).with({ "feedback" => "MyText" })
        put :update, {:id => feedback.to_param, :feedback => { "feedback" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the feedback as @feedback" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Feedback.any_instance.stub(:save).and_return(false)
        put :update, {:id => feedback.to_param, :feedback => { "feedback" => "invalid value" }}, valid_session
        assigns(:feedback).should eq(feedback)
      end
